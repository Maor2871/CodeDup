...
class ClientMonitorWindow(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        # A mutex to prevent a communicator thread to update an executor monitor while refreshing the monitors.
        self.executors_monitors_lock = Lock()
    ...
    def check_new_executor(self, executor_id):
        """
            The function checks if that executor already has a monitor, if he doesn't create him one.
        """
    ...
    def refresh_monitors(self, executor_id):
        """
            The function is being called when a change has been made and the monitors structure should get changed.
        """

        # Set the monitors lock.
        self.executors_monitors_lock.acquire()
        ...
        # Release the lock.
        self.executors_monitors_lock.release()
    ...
    def update_recorder(self):
        ...
        # Wait for the monitors to be available.
